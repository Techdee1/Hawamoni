  ...
  return (
    <div className="min-h-screen bg-midnight text-white overflow-hidden">
      ...
      <nav className={`fixed top-0 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-out ${
        isScrolled 
          ? 'w-[95%] lg:w-[60%] mt-4 bg-midnight/60 backdrop-blur-xl border border-slate/30 rounded-2xl shadow-2xl shadow-solana-teal/10' 
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 justify-between items-center">
            ...
            <div className="md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-lg text-white hover:text-solana-teal hover:bg-slate/20 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-solana-teal transition-colors"
              >
          ...
          <div className={`md:hidden transition-all duration-300 ease-in-out ${
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-slate/20 rounded-xl mt-2 backdrop-blur-sm border border-slate/30">
              <Link 
                href="#features" 
                className="block px-3 py-2 text-base font-medium text-muted hover:text-solana-blue hover:bg-slate/30 rounded-lg transition-colors"
              ...
              <Link 
                href="/signin" 
                className="block px-3 py-2 text-base font-medium text-muted hover:text-white hover:bg-slate/30 rounded-lg transition-colors"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Sign In
              </Link>
